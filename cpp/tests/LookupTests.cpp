...
TEST_CASE("can setup stream") {
    FsFreqDbReader fsFreqDbReader("/Users/chris.hodges/GB_50_20140101.freqdb");
}

TEST_CASE("can read file with billions of entries") {
    FsFreqDbReader fsFreqDbReader("/Users/chris.hodges/GB_50_2014-2021.freqdb");
    ...
    std::vector<int> deepIn(freqsInDb.begin() + 91074969, freqsInDb.begin() + 91075000);
...
TEST_CASE("can do 16 thread lookup on very large file") {
    FsFreqDbReader fsFreqDbReader("/Users/chris.hodges/GB_50_20140101.freqdb");
    ...
    int endTime = fsFreqDbReader.freqDbMetaData.endDate - fsFreqDbReader.freqDbMetaData.startDate;
    std::vector<LookupResult> result = fsFreqDbReader.lookup(lookupFreqs, 10, 0, endTime, 16);
