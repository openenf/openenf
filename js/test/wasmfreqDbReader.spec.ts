// @ts-ignore
import {default as Module} from '../src/freqDbReader.wasm.js';
import {arrayToVectorInt16_t, vectorToArray} from "../src/FreqDbWasmHelpers";

describe('fsFreqDbReader', () => {
    const path = "../src/freqDbReader.wasm.js"
    beforeAll(done => {
