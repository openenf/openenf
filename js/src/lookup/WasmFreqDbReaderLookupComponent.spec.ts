import {WasmFreqDbReaderLookupComponent} from "./wasmFredDbReaderLookupComponent";
...
describe("WasmFreqDbReaderLookupComponent", () => {
    it("Can do a 100 second lookup on the GB_50_Jan2014.freqdb database", async () => {
        ...
        const wasmPath = "/Users/chris.hodges/openEnfPublicRepo/js/src/lookup/freqDbReader.wasm.js";
        const lookupComponent = new WasmFreqDbReaderLookupComponent(wasmPath);
        await lookupComponent.loadDb(dbPath);
