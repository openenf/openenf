...
describe("TcpServerLookupComponent", () => {
    ...
    it('will fire the executable if the server is not running on the specified port and executable can be found', async () => {
        const tcpServerComponentOptions = new TcpServerComponentOptions();
        ...
        try {
            response = await tcpServerLookupComponent.lookup([50.001, 50.002, 50.003, 50.004], ["ZZ"]);
        } finally {
